...
h1b_a = foreach h1b generate job_title,case_status;
h1b_b = filter h1b_a by case_status == 'CERTIFIED-WITHDRAWN';
h1b_c= filter h1b_a by case_status == 'CERTIFIED';
h1b_d = group h1b_a by job_title;
h1b_e = group h1b_c by job_title;
h1b_f = group h1b_b by job_title;
h1b_g = foreach h1b_d generate group as job_pos, COUNT(h1b_a) as cnt;
h1b_h = foreach h1b_e generate group as job_pos, COUNT(h1b_c) as cnt;
h1b_i = foreach h1b_f generate group as job_pos, COUNT(h1b_b) as cnt;
...
h1b_order1 = order h1b_m by $2 desc;
dump h1b_order1;
